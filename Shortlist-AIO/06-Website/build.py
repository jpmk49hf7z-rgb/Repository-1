...
Keeps ../03-Legal-For-Review/*.md as the single source of truth. Editing a policy in one
...
LEGAL = SITE.parent / "03-Legal-For-Review"

PAGES = [
    ("5-Privacy-Policy.md", "privacy.html", "Privacy Policy"),
    ("6-Website-Terms-of-Use.md", "terms.html", "Terms of Use"),
]
...
<title>{title} — Shortlist AIO</title>
...
<header class="site"><div class="wrap"><div class="bar">
  <a class="wordmark" href="/">Shortlist<span>AIO</span></a>
...
<footer class="site"><div class="wrap">
  ...
  <p><strong>Shortlist AIO</strong> is operated by Glass House Gardens Inc., a Manitoba corporation.</p>
</div></footer>
</body>
</html>
"""
...
def main() -> int:
    ...
    if problems:
        ...
        print("\nFill the bracketed fields in ../03-Legal-For-Review/ before deploying.", file=sys.stderr)
        return 1
